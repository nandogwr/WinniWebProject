                ...
                <div class="card mb-5 mb-xl-8 mt-10">
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--end::Toolbar-->
                            <!--begin::Add member-->
                             <button type="button" class="btn btn-sm btn-primary" onclick="tambah_data()" data-bs-toggle="modal" data-bs-target="#kt_modal_member">
                    ...
                    <div class="card-body table-responsive pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_member" data-url="<?= base_url('table/member',true); ?>">
                            <thead>
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="min-w-10px pe-2" data-orderable="false" data-searchable="false">No</th>
                                    <th class="min-w-200px">Data Member</th>
...
<!-- Modal Tambah member -->
<div class="modal fade" id="kt_modal_member"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="form_member" class="form" action="<?= base_url('master/tambah/member',true) ?>" method="POST" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                        ...
                        <div class="fv-row mb-7 d-flex justify-content-center align-items-center flex-column">
                            ...
                            <div class="image-input image-input-circle background-partisi" data-kt-image-input="true" style="background-image: url('<?= image_check('user.jpg','default') ?>')">
                                ...
                                <label class="btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Edit Data">
                                    ...
                                    <!--begin::Inputs-->
                                    <input type="file"  id="member_file" name="image" accept=".png, .jpg, .jpeg" />
                    ...
                    <div class="text-center pt-15">
                        <button type="button" id="submit_member" onclick="submit_form(this,'#form_member')" class="btn btn-primary">
