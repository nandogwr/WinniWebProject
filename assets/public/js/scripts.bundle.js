    ...
    return {
        init: function() {
            ...
            ! function() {
                ...
                })))), o(), "undefined" != typeof countUp && (!1 === n && (o(), window.addEventListener("scroll", o)), [].slice.call(document.querySelectorAll('[data-kt-countup-tabs="true"][data-bs-toggle="tab"]')).map((function(e) {
                    "1" !== e.getAttribute("data-kt-initialized") && (e.addEventListener("shown.bs.tab", o), e.setAttribute("data-kt-initialized", "1"))
                })), n = !0), "undefined" != typeof autosize && [].slice.call(document.querySelectorAll('[data-kt-autosize="true"]')).map((function(e) {
                ...
                function() {
                    ...
                    (e || 0 !== e.length) && e.forEach((function(e) {
                        "1" !== e.getAttribute("data-kt-initialized") && (a(e), e.setAttribute("data-kt-initialized", "1"))
                    }))
                }(), e = !0
        },
            ...
            var i = {
                ...
                A = function(e) {
                    if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.accordion.show", e)) {
                        ...
                        !0 === L(e, "expand") ? i = !0 : !1 === L(e, "expand") ? i = !1 : !0 === L(n.element, "expand") && (i = !0), !1 === i && I(e), !0 === KTUtil.data(e).has("popper") && w(e), KTUtil.addClass(e, "hover"), KTUtil.addClass(e, "showing"), KTUtil.slideDown(t, n.options.accordion.slideSpeed, (function() {
...
var KTLayoutHeader = function() {
    ...
    return {
        init: function() {
            e = document.querySelector("#kt_header"),
                function() {
                    if (e) {
                        var t = KTSticky.getInstance(e);
                        t && t.on("kt.sticky.change", (function() {
                            setTimeout((function() {
...
KTUtil.onDOMContentLoaded((function() {
    KTLayoutHeader.init()
})), "undefined" != typeof module && void 0 !== module.exports && (module.exports = KTLayoutHeader);